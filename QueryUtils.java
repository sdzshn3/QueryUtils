...
public class QueryUtils {
    ...
    private ArrayList<TeluguNewsModel> extractTeluguNewsFromRss(String requestUrl, int noOfArticles) {
    ...
    private ArrayList<TeluguNewsModel> extractFeatureFromJson(String newsJSON) {
        if (TextUtils.isEmpty(newsJSON)) {
            return null;
        }

        ArrayList<TeluguNewsModel> news = new ArrayList<>();
        ...
        try {
            ...
            if (status.equals("ok")) {
                ...
                for (int i = 0; i < pageSize; i++) {
                    ...
                    TeluguNewsModel newsResult = new TeluguNewsModel(title, articleUrl, publishedAt, thumbnail);
                    news.add(newsResult);
                }
            }
        } catch (JSONException e) {
